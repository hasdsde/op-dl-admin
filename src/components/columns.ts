export const versionColumns: any = [
    ...
    {name: 'num', align: 'center', label: '版本号', field: 'Num'},
    {name: 'startTime', align: 'center', label: '开始时间', field: 'startTime'},
    {name: 'endTime', align: 'center', label: '结束时间', field: 'endTime'},
    {name: 'title', align: 'center', label: '标题', field: 'title',},
    {name: 'tag', align: 'center', label: '标签', field: 'versionTag',},
